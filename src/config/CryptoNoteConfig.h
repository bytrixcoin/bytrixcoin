...
// Copyright (c) 2018-2019, BytriX TeaM
//
...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 19663;
	...
	const uint64_t MAX_EXTRA_SIZE_V3_HEIGHT = 1470000;
        ...
        const uint64_t TRANSACTION_SIGNATURE_COUNT_VALIDATION_HEIGHT = 1000000;
    ...
    const char CRYPTONOTE_NAME[] = "BytriX";
    ...
    const char LATEST_VERSION_URL[] = "https://github.com/bytrixcoin/bytrixcoin/releases";

    const std::string LICENSE_URL = "https://github.com/bytrixcoin/bytrixcoin/blob/master/LICENSE";
